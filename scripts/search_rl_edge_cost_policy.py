...
from ssir.pathfinder import montecarlo, rl_edge_cost_policy
...
def main():
    ...
    parser.add_argument("--env-dir", default="/fast/hslyu/results_mmf_vs_density/env")
    ...
    parser.add_argument("--work-dir", default="tmp/rl_edge_cost_search")
    parser.add_argument("--variant", default="base")
    parser.add_argument("--train-start", type=int, default=850)
    parser.add_argument("--train-graphs", type=int, default=5)
    parser.add_argument("--eval-start", type=int, default=800)
    parser.add_argument("--eval-graphs", type=int, default=50)
    parser.add_argument("--epochs", type=int, default=10)
    parser.add_argument("--num-predecessors", type=int, default=100)
    parser.add_argument("--num-rounds", type=int, default=1)
    parser.add_argument("--num-trials", type=int, default=1)
    parser.add_argument("--hidden-dim", type=int, default=128)
    parser.add_argument("--lr", type=float, default=1e-3)
    parser.add_argument("--max-negatives", type=int, default=96)
    parser.add_argument("--policy-arch", choices=["mlp", "gnn"], default="mlp")
    ...
    config = rl_edge_cost_policy.RLEdgeCostConfig(
    ...
    _, history = rl_edge_cost_policy.train_policy(
        train_graphs,
    ...
    rows = []
    learned_scheme = (
        "gnn_edge_cost" if args.policy_arch == "gnn" else "rl_edge_cost"
    )
    ...
    for exp_id in eval_ids:
        ...
        throughput, seconds = time_graph(
            lambda exp_id=exp_id: rl_edge_cost_policy.get_solution_graph(
                load_density_graph(env_dir, exp_id, args.density, args.target_type),
